...
const Home: NextPage = () => {
  return (
    <Layout noFooter>
      <div className="min-h-screen animation-gradient dark:animation-gradient-dark filter">
        <canvas id="canvas"  className="absolute top-0 left-0" />
        <Script
        src="/animation.js"
        strategy="lazyOnload"
      />
        <section className="relative">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            {/* Hero content */}
            <div className="pt-48 pb-12 md:pt-64 md:pb-20">
              ...
              <div className="text-center pb-12 md:pb-16">
                ...
                <div className="pt-8 max-w-3xl mx-auto">
                  <p className="text-xl text-gray-600 mb-8 dark:text-gray-300" data-aos="zoom-y-out" data-aos-delay="150">Stellr is a Web 3.0 social network application being built on top of Lens Protocol and Polygon. Join our Discord to learn more.</p>
