...
import { Collapsible, Icon } from 'components/UI';
...
const Faq = ({ question, answer, id }: { question:string, answer: string, id:number }) => {
  ...
  return (
    <Collapsible
      ...
      trigger={(
        <div className="bg-primary-400 dark:bg-primary-700 rounded flex justify-between">
          <div>
    ...
    >
      <div className="bg-primary-400 dark:bg-primary-700 rounded">
